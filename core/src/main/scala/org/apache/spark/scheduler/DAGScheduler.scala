...
class DAGScheduler(
  ...
  def runJob[T, U](
    ...
    if (mode == 0 || first_iter == 1) {
//      println("DAGScheduler: I am waiting")
    ...
    if (mode == 1){
      first_iter = 0
//      println("DAGScheduler: I am not waiting!")
    }

//    println("DAGScheduler: WAITING FINISHED ******")


//    println("DAGScheduler: DOOOOOONNNNNNEEEEEE ***********")
...
//      println("DAGScheguler: task size: "+taskBinaryBytes.size)
    } catch {
