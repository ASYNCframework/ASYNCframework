...
abstract class Broadcast[T: ClassTag](val id: Long) extends Serializable with Logging {
  ...
  //scalastyle:off
  def getBroadcastID(): BroadcastBlockId ={
    getID()
  }

  def changeBroadcastID(newID: Long): Unit ={
    changeID(newID)
  }
  ...
  /**
    * Actually get the broadcasted ID.
    * Added by Saeed
    */

  protected def getID(): BroadcastBlockId

  /**
    * Change the broadcast ID just to test my idea.
    * Added by Saeed
    */

  protected def changeID(newID: Long):Unit
  /**
