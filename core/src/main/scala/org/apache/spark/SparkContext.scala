...
class SparkContext(config: SparkConf) extends Logging {
  ...
  def set_numFinishedPar(i:Int): Unit ={

    numFinishedPar = i
  }
  def get_numFinishedPar(): Int ={
    numFinishedPar
  }
  /*def set_currentJobResult(): Unit ={
    currentJobResult =
  }*/
  ////////////////////////// SAEED ///
  ...
  def runJob[T, U: ClassTag](
    ...
    //scalastyle:off
//    print("SparkContext: running a job with rdd id: ")
//    println(rdd.id)
    ////////////////////////// SAEED ///
    dagScheduler.set_mode(mode)
